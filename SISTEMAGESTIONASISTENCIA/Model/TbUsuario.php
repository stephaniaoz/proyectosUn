...
Class TbUsuario{
	...
	public function getUsuario($usuario_perfil){

		$consulta_usuario_segun_perfil = " SELECT u.usuario_identificacion, u.usuario_nombre, u.usuario_apellidos
											FROM tb_usuario u
											JOIN tb_itemusuarioperfil i ON i.usuario_codigo = u.usuario_codigo
											WHERE i.perfil_codigo = ".$usuario_perfil.";";

		$result_usuario_segun_perfil = pg_query($consulta_usuario_segun_perfil);

		return $result_usuario_segun_perfil; 
	}
